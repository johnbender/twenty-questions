...
\begin{frame}{Interactive Specification Refinement}
  \begin{block}{Synthesizzle or Synthesnooze}
    Synthesis is very cool, but currently very limited
...
\begin{frame}{Many Jungloids}
  \begin{block}{Bienvenido a la Jungla}
    Initial type based synthesis work out of Berkley

    \begin{itemize}
      \item ``spec'' is a type pair, e.g. $(FactoryFactory, FactoryBean)$
...
\begin{frame}{Many Jungloids}
  add initial twenty questions example
\end{frame}
